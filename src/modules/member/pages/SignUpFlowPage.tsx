          ...
          >
            <Card className="bg-zinc-900 border-zinc-800 text-white shadow-2xl">
              <CardHeader className="space-y-1">
                ...
                <CardDescription className="text-zinc-400 font-medium">Tell us more about yourself to get started.</CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor="fullName" className="text-xs font-bold uppercase text-zinc-500">Full Name</Label>
                    <Input id="fullName" placeholder="John Doe" value={formData.fullName} onChange={handleInputChange} className="bg-zinc-800 border-zinc-700 focus:border-indigo-500 transition-all font-medium" />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="dob" className="text-xs font-bold uppercase text-zinc-500">Date of Birth</Label>
                    <Input id="dob" type="date" value={formData.dob} onChange={handleInputChange} className="bg-zinc-800 border-zinc-700 focus:border-indigo-500 transition-all font-medium" />
                  </div>
                  <div className="space-y-2">
                    ...
                    <Select onValueChange={(v) => handleSelectChange('gender', v)}>
                      <SelectTrigger className="bg-zinc-800 border-zinc-700 font-medium">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="contact" placeholder="+91 98765 43210" value={formData.contact} onChange={handleInputChange} className="bg-zinc-800 border-zinc-700 focus:border-indigo-500 transition-all font-medium" />
                  </div>
                </div>

                <div className="space-y-2">
                  <Label htmlFor="address" className="text-xs font-bold uppercase text-zinc-500">Full Address</Label>
                  <Input id="address" placeholder="123 Street, Area" value={formData.address} onChange={handleInputChange} className="bg-zinc-800 border-zinc-700 focus:border-indigo-500 transition-all font-medium" />
                </div>

                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor="state" className="text-xs font-bold uppercase text-zinc-500">State</Label>
                    <Input id="state" placeholder="Tamil Nadu" value={formData.state} onChange={handleInputChange} className="bg-zinc-800 border-zinc-700 focus:border-indigo-500 transition-all font-medium" />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="district" className="text-xs font-bold uppercase text-zinc-500">District</Label>
                    <Input id="district" placeholder="Chennai" value={formData.district} onChange={handleInputChange} className="bg-zinc-800 border-zinc-700 focus:border-indigo-500 transition-all font-medium" />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="country" className="text-xs font-bold uppercase text-zinc-500">Country</Label>
                    <Input id="country" value={formData.country} readOnly className="bg-zinc-800/50 border-zinc-700 text-zinc-400 font-medium cursor-not-allowed" />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="pincode" className="text-xs font-bold uppercase text-zinc-500">Pincode</Label>
                    <Input id="pincode" placeholder="600001" value={formData.pincode} onChange={handleInputChange} className="bg-zinc-800 border-zinc-700 focus:border-indigo-500 transition-all font-medium" />
                  </div>
                </div>
          ...
          >
            <Card className="bg-zinc-900 border-zinc-800 text-white shadow-2xl">
              <CardHeader className="space-y-1">
                ...
                <CardDescription className="text-zinc-400 font-medium">Verify your identity by providing your card details and documents.</CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="space-y-4">
                  <div className="space-y-2">
                    <Label htmlFor="aadhaarNumber" className="text-xs font-bold uppercase text-zinc-500">Aadhar Card Number</Label>
                    <Input id="aadhaarNumber" placeholder="XXXX XXXX XXXX" value={formData.aadhaarNumber} onChange={handleInputChange} className="bg-zinc-800 border-zinc-700 focus:border-indigo-500 transition-all font-medium" />
                    <div className="mt-2">
                      <label htmlFor="aadhaarDoc" className="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-zinc-700 rounded-xl cursor-pointer hover:bg-zinc-800/50 hover:border-indigo-500 transition-all group">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="panNumber" placeholder="ABCDE1234F" value={formData.panNumber} onChange={handleInputChange} className="bg-zinc-800 border-zinc-700 focus:border-indigo-500 transition-all font-medium" />
                    <div className="mt-2">
                      <label htmlFor="panDoc" className="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-zinc-700 rounded-xl cursor-pointer hover:bg-zinc-800/50 hover:border-indigo-500 transition-all group">
                        <div className="flex flex-col items-center justify-center pt-5 pb-6">
                          <FileUp className="w-8 h-8 text-zinc-500 mb-2 group-hover:text-indigo-500 transition-colors" />
                          <p className="text-sm text-zinc-400 font-medium">
                ...
                <div className="flex gap-4">
                  <Button variant="ghost" onClick={() => setStep(1)} className="flex-1 border border-zinc-800 hover:bg-zinc-800 font-bold h-12 rounded-xl">BACK</Button>
