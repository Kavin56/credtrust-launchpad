    ...
    <div className="w-full max-w-sm mx-auto animate-in fade-in slide-in-from-left-4 duration-500">
      ...
      <form onSubmit={handleLogin} className="space-y-6">
        ...
        <Button 
          ...
          variant="outline"
          className="w-full h-12 rounded-lg flex items-center justify-center gap-2 border-gray-200 hover:bg-gray-50 transition-all font-medium text-gray-700 shadow-sm"
          disabled={loading}
        >
