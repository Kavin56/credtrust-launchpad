           ...
           <div className="max-w-[400px] mx-auto w-full">
              ...
              <form onSubmit={handleLogin} className="space-y-6">
                ...
                <div className="space-y-2">
                   ...
                   <Input
                      type="password"
                      placeholder="Institutional access key"
                      required
                      className="h-14 rounded-2xl border-gray-100 bg-gray-50 focus:bg-white focus:ring-2 focus:ring-[#c9a84c] transition-all font-bold tracking-widest"
                      value={secretKey}
                ...
                <p className="text-[11px] text-gray-400 font-medium leading-relaxed">
                  Portal admins use a dedicated database. Default seed: admin@sharanam.local — set ADMIN_ACCESS_KEY in API .env.
                </p>
                <p className="text-center text-xs text-slate-400 pt-2">
                  <Link to="/agent/login" className="font-bold text-[#1a1f36] hover:underline">Agent portal login</Link>
                </p>
              </form>
